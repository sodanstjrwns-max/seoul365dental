...
export const pricingData: PricingItem[] = [
  ...
  { treatment: 'CA (대표원장)', price: '10만원', insurance: '비급여', category: '보존' },
  { treatment: '레진 충치치료 (대표원장)', price: '10~22만원', insurance: '비급여', category: '보존', note: '수복이 필요한 부위와 크기에 따라' },
  ...
  // ── 교정 치료 (저렴한 순) ──
  { treatment: '교정용 왁스', price: '0.5만원', insurance: '비급여', category: '교정' },
  { treatment: 'FIXED 재부착', price: '2만원', insurance: '비급여', category: '교정' },
  { treatment: 'FIXED 제거', price: '2만원', insurance: '비급여', category: '교정' },
  ...
  { treatment: 'FIXED 재제작', price: '20만원', insurance: '비급여', category: '교정' },
  { treatment: 'CIRCUM', price: '20만원', insurance: '비급여', category: '교정' },
  ...
  { treatment: '무삭제 라미네이트 (이벤트)', price: '40만원', insurance: '비급여 (과세)', category: '미용', note: '이벤트' },
