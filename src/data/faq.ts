export const mainFaq = [
  {
    q: '임플란트 비용은 얼마인가요?',
    a: '서울365치과 기준 오스템 이벤트 64만원, 메가젠 79만원, 오스템 89만원, 오스템 프리미엄 SOI 104만원, 스트라우만 이벤트 129만원입니다. 65세 이상은 2개까지 건강보험 적용 가능합니다.',
  },
  {
    q: '임플란트 수명은 얼마나 되나요?',
...
export const pricingData: PricingItem[] = [
  // ── 임플란트 치료 (저렴한 순) ──
  { treatment: '오스템 임플란트 (이벤트)', price: '64만원', insurance: '비급여', category: '임플란트', note: '이벤트' },
  ...
  { treatment: '스트라우만 (이벤트)', price: '129만원', insurance: '비급여', category: '임플란트', note: '이벤트' },
