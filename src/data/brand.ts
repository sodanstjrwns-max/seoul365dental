...
보철을 전문으로 하는 상세훈 원장은, 모든 치료 전 CT 촬영과 구강 스캔을 통한 정밀 분석을 거칩니다. 환자와 함께 진단 결과를 공유하고, 최적의 치료 방향을 함께 결정합니다.`,
    profileSummary: [
      '서울대학교 치과대학 졸업, 치의학대학원 석사',
      '정밀 진단 기반의 보철 전문',
  ...
  'ha-nuri': {
    storyIntro: `하누리 원장은 원광대학교 치과대학을 졸업한 뒤, 같은 대학원 교정과에서 전공의 수련을 마친 교정과 전문의입니다. 인비절라인 인증의 자격도 보유하고 있습니다.
...
"아름다운 미소는, 건강한 교합에서 시작됩니다."`,
  ...
  'cha-haena': {
    storyIntro: `차해나 원장은 연세대학교 생명공학과를 졸업한 뒤, 서울대학교 치과대학에 진학하여 같은 대학원에서 석사 학위를 취득했습니다. 서울대학교 치과병원 종합진료실에서 폭넓은 임상 경험을 쌓았습니다.

생명공학이라는 기초과학의 시선과 치의학의 정밀함을 함께 갖춘 것이 차해나 원장의 강점입니다. 그는 미국 Tufts·New York University, 호주 University of Melbourne, 중국 Sichuan University 등 세계 유수의 치과대학에서 연수하며 국제적인 진료 감각을 익혔습니다.

"환자 한 분 한 분의 이야기에 귀 기울이는 것이 진료의 출발점입니다."`,
    profileSummary: [
      '연세대 생명공학과·서울대 치과대학 졸업, 치의학대학원 석사',
      '미국·호주·중국 유수 치과대학 국제 연수 이수',
      '보철·심미·보존치료 및 종합진료 담당',
    ],
    principle: '환자의 이야기에 귀 기울이는 것이, 진료의 출발점입니다.',
  },
} as const;
