...
export const doctors: Doctor[] = [
  {
    ...
    title: '대표원장',
    titleShort: '대표원장',
    photo: '/static/dr-park-junkyu-profile.jpg',
    ...
    specialties: ['전체임플란트', '디지털풀아치', '심미보철', '수면임플란트'],
    treatmentLinks: ['/treatments/full-implant', '/treatments/digital-full-arch', '/treatments/implant'],
